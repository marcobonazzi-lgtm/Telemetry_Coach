...
public class MiniChartBox extends VBox {
    ...
    public MiniChartBox(String title, ChartPane.PlotType def){
        ...
        // --- PERFORMANCE FIX: Disabilita animazioni e simboli (Già presente) ---
        chart.setAnimated(false);
        chart.setCreateSymbols(false);

        // --- PERFORMANCE FIX AVANZATO: Cache Bitmap ---
        // Questo dice a JavaFX: "Quando non cambi i dati, tratta questo grafico come una foto".
        // Risolve drasticamente gli scatti durante lo scroll della pagina.
        chart.setCache(true);

...
final class ChartRenderers {
    ...
    private static int addForceSeriesIfPresent(LineChart<Number,Number> chart,
        ...
        // OTTIMIZZAZIONE: Creazione batch della lista e inserimento unico con setAll
        ArrayList<XYChart.Data<Number,Number>> buffer = new ArrayList<>(xs.size());
        for (int i = 0; i < xs.size(); i++) {
            buffer.add(new XYChart.Data<>(xs.get(i), ys.get(i)));
        }

...
public final class CoachSession {
    ...
    public static List<String> generateSessionNotes(List<Lap> laps){
        ...
        // <<< AGGIUNTA QUI: note aggregate di performance >>>
        out.addAll(CoachPerformance.generateSession(laps));
        // <<< FINE AGGIUNTA >>>
        ...
        // Merge concetti + sort
        out = mergeByConcept(out);  // <<< mantiene solo la fusione/normalizzazione >>>
